			...
			<div class="card-body tab-content">
									...
									<div class="form-group">
										<div class="input-group" id="date_of_birth" style="width:100%;">
											<div class="input-group-content">
												<input type="text" class="form-control date-pick" name="date_of_birth" value=@if (isset($data['date_of_birth'])){{ $data['date_of_birth'] }}@endif>
				...
				<div class="tab-pane " id="contact">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="address_address[0]" value="{{$value['value']}}"></input>
					...
					@endif
						...
						<div class="row">
							<div class="col-md-4">
								<div class="" id="bbmList">
								</div>							
								<div class="form-group row" style="padding-top">
									<div class="col-md-12">
										<a class="btn btn-raised btn-default-bright pull-right" data-duplicate="bbmTmpl" data-target="#bbmList">TAMBAHKAN AKUN BBM</a>
									</div>
								</div>							
							</div>		
							<div class="col-md-4">
								<div class="" id="lineList">
								</div>							
								<div class="form-group row" style="padding-top">
									<div class="col-md-12">
										<a class="btn btn-raised btn-default-bright pull-right" data-duplicate="lineTmpl" data-target="#lineList">TAMBAHKAN AKUN LINE</a>
									</div>
								</div>							
							</div>	
							<div class="col-md-4">
								...
								<div class="form-group row" style="padding-top">
									<div class="col-md-12">
										<a class="btn btn-raised btn-default-bright pull-right" data-duplicate="waTmpl" data-target="#waList">TAMBAHKAN AKUN WHATSAPP</a>
									</div>
								</div>							
							</div>																				
						</div>	
...
@section('js')
					...
					<!-- BEGIN RELASI DETAIL -->	
						<div class="tabs-left">
							<ul class="card-head nav nav-tabs" data-toggle="tabs">
								<li id="title_panel1_<%=index%>"><a href="javascript:;" onClick="show_panel1(this.id);" id="panel1_<%=index%>">Data Lama</a></li>
								<li class="active" id="title_panel2_<%=index%>"><a href="javascript:;" onClick="show_panel2(this.id);" id="panel2_<%=index%>">Data Baru</a></li>								
							</ul>
							<div class="card-body tab-content style-default-bright">
								...
								<!-- tab2 -->
								<div class="tab-pane active" id="tmpl_panel2_<%=index%>">
								<div class="row">
									<div class="col-xs-12">
										<div class="row">
											<div class="col-md-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<div class="input-group" id="date_of_birth_relation[<%=index%>]" style="width:100%; text-align:left;">
														<div class="input-group-content">
															<input type="text" class="form-control date-pick" name="date_of_birth_relation[<%=index%>]" />
															<label>Tanggal Lahir</label>
														</div>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" id="phone_relation[<%=index%>]" name="phone_relation[<%=index%>]">
													<label for="phone_relation[<%=index%>]">Nomor Telepon</label>
												</div>
											</div>
										</div>
									</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<label for="work_status[<%=index%>]">Status Pegawai</label>						
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<div class="input-group" id="work_start_cal[<%=index%>]" style="width:100%;">
							<div class="input-group-content">
								<input type="text" class="form-control date-pick" id="work_start[<%=index%>]" name="work_start[<%=index%>]">
							</div>
						</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						<div class="input-group" id="work_end_cal[<%=index%>]" style="width:100%;">
							<div class="input-group-content">
								<input type="text" class="form-control date-pick" id="work_end[<%=index%>]" name="work_end[<%=index%>]">
							</div>
						</div>
	...
	<script type="text/html" id="addressTmpl">
		<li class="clearfix">
			<div class="page-header no-border holder">
				<h4 class="text-accent">Alamat</h4>
			</div>
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
	...
	<!-- BEGIN BBM TEMPLATES -->
	<script type="text/html" id="bbmTmpl">
		<li>
			<div class="page-header no-border holder">
				<a class="btn btn-icon-toggle btn-accent btn-delete stick-top-right"><span class="md md-delete"></span></a>
				<h4 class="text-accent">&nbsp;</h4>
				...
				<div class="form-group">
					...
					<label for="contact_BBM[<%=index%>]">Akun BBM [<%=index%>]</label>
				</div>
			</div>
		</li>
	</script>
	...
	<!-- BEGIN LINE TEMPLATES -->
	<script type="text/html" id="lineTmpl">
		<li>
			<div class="page-header no-border holder">
				<a class="btn btn-icon-toggle btn-accent btn-delete stick-top-right"><span class="md md-delete"></span></a>
				<h4 class="text-accent">&nbsp;</h4>
				...
				<div class="form-group">
					...
					<label for="contact_LINE[<%=index%>]">Akun LINE [<%=index%>]</label>
				</div>
			</div>
		</li>
	</script>
	...
	<!-- BEGIN WA TEMPLATES -->
	<script type="text/html" id="waTmpl">
		<li>
			<div class="page-header no-border holder">
				<a class="btn btn-icon-toggle btn-accent btn-delete stick-top-right"><span class="md md-delete"></span></a>
				<h4 class="text-accent">&nbsp;</h4>
				...
				<div class="form-group">
					...
					<label for="contact_WhatsApp[<%=index%>]">Akun WhatsApp [<%=index%>]</label>
				</div>
			</div>
		</li>
	</script>
