	...
	<div class="card">
		...
		<div class="card-head card-head-sm style-primary">
			<div class="col-md-6 col-xs-6 pt-5">
				<a href="{{route('hr.report.attendance.detail', ['id' => $person['id'],'page' => 1, 'start' => Input::get('start'), 'end' => Input::get('end'), 'org_id' => Input::get('org_id')])}}" class="btn btn-flat ink-reaction pull-left"><i class="md md-reply"></i> Kembali</a>				
