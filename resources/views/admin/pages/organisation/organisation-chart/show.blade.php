...
@section('content')
				...
				<div class="col-sm-10">
					<div class="margin-bottom-xxl row">
						<div class="col-sm-10 col-md-10">
							...
							<h3 class="text-light text-lg no-margin opacity-50">PT. Mentari Pagi Sejahtera</h3>
						</div>											
					</div>
				</div>											
			</div>
	...
	@if($controller_name == "department")
		<h1 class='text-primary pt-10'>Daftar Jabatan</h1>
	@elseif($controller_name == "position")
		<h1 class='text-primary pt-10'>Daftar Pegawai</h1>
	@endif
