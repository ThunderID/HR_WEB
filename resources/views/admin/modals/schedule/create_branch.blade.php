<div class="modal fade modalChart" id="branchCreate" tabindex="-1" role="dialog" aria-labelledby="branchCreate" aria-hidden="true">
	<div class="modal-dialog form">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title text-xl modal_contact_title" id="formModalLabel">Tambah Chart di Kalendar ini</h4>
			</div>
