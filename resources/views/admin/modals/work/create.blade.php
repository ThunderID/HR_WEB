					...
					<div class="col-md-6">
						<div class="form-group">
							<div class="input-group" id="work_start" style="width:100%;">
								...
								@if($isNew == false)
									{!! Form::input('text', 'work_start', $value['start'], ['class' => 'form-control date_mask', 'data-inputmask' => '"alias" : "date"', 'id'=>'work_start']) !!}
								@else
							...
							<div class="input-group" id="work_end" style="width:100%;">
								<div class="input-group-content">
									@if($isNew == false)
										...
										@else
											{!! Form::input('text', 'work_end', $value['end'], ['class' => 'form-control date_mask', 'data-inputmask' => '"alias" : "date"', 'id'=>'work_end']) !!}
