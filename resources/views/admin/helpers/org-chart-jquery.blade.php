...
(function($) {
    ...
    function OrgChart($container, opts){
        ...
        this.startEdit = function(id, val){
            var inputElement = $('<input class="org-input" type="text" value="'+val+'"/>');
            $container.find('div[node-id='+id+'] h2').replaceWith(inputElement);
            var h2Element = $('<h2>'+val+'</h2>');
    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(opts.showControls){
                var buttonsHtml = "<div title='Hak Akses' class='org-config-button'><a href='#'><i class='fa fa-lock fa-lg'></i></div>"
                if(this.data.id > 1){
                    buttonsHtml = buttonsHtml + "<div class='org-add-button'title='Tambah'><i class='fa fa-plus-circle fa-lg'></i></div><div title='Hapus' class='org-del-button danger'><i class='fa fa-trash-o fa-lg'></i></div>";
                }else{
                    buttonsHtml = buttonsHtml + "<div class='org-add-button org-add-button-1st' title='Tambah'><i class='fa fa-plus-circle fa-lg'></i></div>";
                }
            }
            else{
                buttonsHtml = '';
