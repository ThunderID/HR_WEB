...
<div class="hbox-column col-md-2" id="sidebar_left">
	<ul class="nav nav-pills nav-stacked">
		...
		<li @if(!isset($authentications)) class="active" @endif><a href="{{route('hr.charts.calendars.index', ['id' => $chart['id'], 'org_id' => $data['id'], 'branchid' => $branch['id']])}}"> Kalender Kerja </a></li>
	</ul>
</div>